...
SINT32 SEC_ShareZone_Init(VDEC_OPERATION_S *pArgs, UINT32 * Share);
...
SINT32 SEC_ControlAdjust(SINT32 ChanID, VDEC_CID_E eCmdID, VOID *pArgs, UINT32 ArgLen);
...
SINT32 SEC_CheckPowerStat(VOID);
