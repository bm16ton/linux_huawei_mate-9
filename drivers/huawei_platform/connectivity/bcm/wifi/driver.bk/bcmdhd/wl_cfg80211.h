...
extern s32 wl_cfg80211_set_nmode(struct net_device *ndev, u8 nmode);
#endif
...
#ifdef HW_SET_PM
extern s32 wl_cfg80211_powerlock(struct net_device *dev, bool enable);
#endif
