...
#define DHD_SCAN_UNASSOC_ACTIVE_TIME_PS 40
#define DHD_SCAN_PASSIVE_TIME 130 /* ms: Embedded default Passive setting from DHD */
#define DHD_SCAN_N_PROBES 2
#endif
...
/* #define WL_ENABLE_P2P_IF		1 */
	...
	*/
    ...
    bool nmode_disable;
    bool nonly_ap;
    struct ether_addr last_fail_bssid;
	wlc_ssid_t last_fail_ssid;		/* {0, ""}: wildcard scan */
	bool wrong_action_flag;
#endif
...
#ifndef HW_HTCLK_AVL_TIMEOUT_PATCH
...
extern int dhd_bus_power_up(dhd_pub_t *dhdpub);
extern int dhd_bus_power_down(dhd_pub_t *dhdpub);
#endif
